...
⚡ 其他网络： X-Layer Solana Aptos Arbitrum-One Base<br>
🏦 交易所收款：Binance Pay、OKX 内部转账 [完整列表](./docs/trade-type.md)
...
- ✅ 地址独占模式 底层支持不定额收款
- ✅ 支持MQTT消息发布 交易信息即时广播
- ✅ 可选读取 Binance / OKX 账单，独立完成交易所收款确认
- ✅ 快速迭代期 超多实用特性功能等你发现
...
- 交易所收款：[Binance / OKX 配置](./docs/exchange-payment.md) [iStoreOS Docker Compose](./docker-compose.yml)
